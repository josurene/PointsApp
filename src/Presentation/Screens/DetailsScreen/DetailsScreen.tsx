  ...
  return (
    <View>
      <View style={DetailsScreenStyle.header}>
        <Text style={DetailsScreenStyle.headerText}>
      ...
      <View style={DetailsScreenStyle.mainContainer}>
        ...
        <Text style={DetailsScreenStyle.purchasedDate}>
          Comprado el {purchasedDate}
        </Text>
        <Text style={DetailsScreenStyle.pointsText}>
          Con esta compra acumulaste:
        </Text>
        <Text style={DetailsScreenStyle.points}>
